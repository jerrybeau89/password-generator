...
function passwordGenerator () {
  ...
  do{
    includeLowerCase = prompt("Would you like to include lower case letters in your password? (Yes or No)")
  } while (!includeLowerCase, !(includeLowerCase.toLowerCase() == "yes" || includeLowerCase.toLowerCase() == "no"));

  //This variable uses a do while loop to validate if the user inputs yes/no as the prompt response. Any and all other answers will force the loop to continue until the either yes or no is provided. Finally it sets the variable's value to the users input.
  var includeUpperCase 
  
  do{ 
    includeUpperCase = prompt("Would you like to include UPPER case letters in your password? (Yes or No)");
  } while (!includeUpperCase, !(includeUpperCase.toLowerCase() == "yes" || includeUpperCase.toLowerCase() == "no"));

  //This variable uses a do while loop to validate if the user inputs yes/no as the prompt response. Any and all other answers will force the loop to continue until the either yes or no is provided. Finally it sets the variable's value to the users input.
  var includeNumbers 
  
  do{
  includeNumbers = prompt("Would you like to include numbers(0-9) in your password? (Yes or No)");
  } while (!includeNumbers, !(includeNumbers.toLowerCase() == "yes" || includeNumbers.toLowerCase() == "no"));

  //This variable uses a do while loop to validate if the user inputs yes/no as the prompt response. Any and all other answers will force the loop to continue until the either yes or no is provided. Finally it sets the variable's value to the users input.
  var includeSpcial 
  do{
  includeSpcial = prompt("Would you like to include special characters in your password? (Yes or No)");
  } while (!includeSpcial, !(includeSpcial.toLowerCase() == "yes" || includeSpcial.toLowerCase() == "no"));
  ...
  function generatePassword() {
    ...
    for (let i = 0; i < passLength; i++) {
      ...
      charSelector = characterChecker[characterNum];
